                    ...
                    <div class="tabs">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="one">										
								<form action="<?php echo U('UserPost/add_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
									<div class="row-fluid">
										<div class="span9">
													...
													<td>
														<div style="text-align: center;">
															...
															<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
																<img src="/themes/simplebootx/Public/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand" />
															</a>
															<input type="button" class="btn btn-small" onclick="$('#thumb_preview').attr('src','/themes/simplebootx/Public/images/default-thumbnail.png');$('#thumb').val('');return false;" value="取消图片" style="margin-top:10px">
														</div>
													</td>
												</tr>
												<tr>
									...
									<div class="form-actions">
										...
										<a class="btn" href="<?php echo U('UserPost/index');?>">返回</a>
									</div>
								</form>
							</div>
						</div>
