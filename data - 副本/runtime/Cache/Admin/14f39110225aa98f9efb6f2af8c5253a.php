...
<body>
	<div class="wrap">
		...
		<div class="home_info" id="home_devteam">
			<ul>
				<li><em>RST管家</em> <a href="http://www.yz-zst.com/" target="_blank">http://www.yz-zst.com/</a></li>
				<li><em><?php echo L('TEAM_MEMBERS');?></em> <span>echoshiki</span></li>
				<li><em><?php echo L('CONTACT_EMAIL');?></em> <span>echoshiki@outlook.com</span></li>
			</ul>
		</div>
	</div>
