                    ...
                    <div class="span9">
                           <div class="tabs">
                               <ul class="nav nav-tabs">
									...
									<li><a href="<?php echo U('UserPost/add',array('term'=>empty($term['term_id'])?'':$term['term_id']));?>" target="_self">添加新闻</a></li>
								</ul>
                               <div class="tab-content">
                                   <div class="tab-pane active" id="one">
                                   		<table class="table table-hover table-bordered table-list">
											...
											<?php $status=array("1"=>"已审核","0"=>"未审核"); $i = 0; ?>
											<?php if(is_array($posts)): foreach($posts as $key=>$vo): $i++; ?>
											<tr>
												<td><?php echo ($i); ?></td>
												...
												<td>
													<?php if($vo['post_status']==1): ?><a href="<?php echo U('portal/article/index',array('id'=>$vo['tid']));?>" target="_blank">查看</a>
													<?php else: ?>	
														<a href="<?php echo U('UserPost/edit',array('term'=>empty($term['term_id'])?'':$term['term_id'],'id'=>$vo['id']));?>">编辑</a> | 
														<a href="<?php echo U('UserPost/delete',array('term'=>empty($term['term_id'])?'':$term['term_id'],'tid'=>$vo['tid']));?>" class="js-ajax-delete" data-msg="你确定删除吗？">删除</a><?php endif; ?>
												</td>
